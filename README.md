...
2. **Change the IP address in App.js file**:

Open App.js file.
Locate the line containing the server address (e.g., http://Enter your ip Address:8080/).
Replace "Enter your ip Address" with your actual IP address.
